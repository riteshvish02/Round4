...
tl1.to('.fullpage-menu', {
	duration:0,
	display: "block",
	ease: 'Expo.easeInOut',
});

tl1.from('.menu-bg span', {
	duration:1,
	x:"100%",
	stagger: 0.1,
	ease: 'Expo.easeInOut'
...
function page3SvgPathAnimation(){
    let path = document.querySelector('.line-progress');
let pathLength = path.getTotalLength();

path.style.strokeDasharray = pathLength + ' ' + pathLength;
path.style.strokeDashoffset = pathLength;
path.style.stroke = "#E5E6E8"; // Set default gray color

gsap.to(path, {
    strokeDashoffset: 0, // This will animate the strokeDashoffset to 0
    stroke: "url(#line-progress)", // Change to blue gradient on scroll
    duration: 15,
    ease: "none",
    scrollTrigger: {
        trigger: ".one", // The container you're scrolling
        scroller: "#main", // Locomotive Scroll scroller
        start: "top 50%",
        end: "top -100%",
        scrub: true,
        markers: true, 
